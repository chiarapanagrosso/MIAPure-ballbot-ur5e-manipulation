function [A, B] = linearizeBallbotModel(p, x_eq, u_eq)
...
%   u_eq - The input vector [8x1] at the equilibrium point.
%
% OUTPUTS:
%   A - The linearized state matrix (10x10).
%   B - The linearized input matrix (10x8).
% =========================================================================
...
syms m_U I_Uy I_Ux Iz l_U m_S I_S r_S h_app g
...
x_sym = [th_x; th_y; th_z; ph_x; ph_y; dot_theta_x; dot_theta_y; dot_theta_z; dot_phi_x; dot_phi_y];
u_sym = [tau_x; tau_y; tau_z; F_px; F_py; F_pz; tau_px; tau_py];
...
param_syms = [m_U, I_Ux, I_Uy, Iz, l_U, m_S, I_S, r_S, h_app, g, b_theta, b_phi, fz];
param_vals = [p.m_U, p.I_Ux, p.I_Uy, p.Iz, p.l_U, p.m_S, p.I_S, p.r_S, p.h_app p.g, p.b_theta, p.b_phi, p.fz];
