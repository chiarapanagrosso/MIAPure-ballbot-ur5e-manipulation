...
bagFilePath = fullfile(basePath, 'ros_packages','bags','final_bag.db3'); 
...
% 
% figure('Name', 'Raw vs. Processed Trajectory', 'Color', 'w');
% tiledlayout(1, 2, 'Padding', 'compact', 'TileSpacing', 'compact');
% 
% % Common style settings
% lineWidth = 2;           % Thicker lines
% fontSizeTitle = 18;      % Bigger title font
% fontSizeLabels = 14;     % Larger axis labels
% fontSizeLegend = 12;     % Legend font size

% --- Plot 1: Raw, Laggy Data ---
% nexttile;
% plot(timeVector, rawJointPositions, 'LineWidth', lineWidth);
% grid on;
% title('Original Laggy Data from ROSBAG', 'FontSize', fontSizeTitle, 'FontWeight', 'bold');
% xlabel('Time (s)', 'FontSize', fontSizeLabels);
% ylabel('Joint Position (rad)', 'FontSize', fontSizeLabels);
% legend(jointNames, 'Interpreter', 'none', 'Location', 'eastoutside', 'FontSize', fontSizeLegend);
% set(gca, 'FontSize', 12);
% 
% % --- Plot 2: Final Processed Data ---
% nexttile;
% plot(time_final, positions_final, 'LineWidth', lineWidth);
% grid on;
% title('Final Processed Trajectory for Simscape', 'FontSize', fontSizeTitle, 'FontWeight', 'bold');
% xlabel('Time (s)', 'FontSize', fontSizeLabels);
% ylabel('Joint Position (rad)', 'FontSize', fontSizeLabels);
% legend(jointNames, 'Interpreter', 'none', 'Location', 'eastoutside', 'FontSize', fontSizeLegend);
% set(gca, 'FontSize', 12);
